...
def process_context_data(users, books, ratings1, ratings2):
    ...
    # user_id, isbn 제거
    for df in [context_df, train_df, test_df] :
        df.drop(columns=['user_id', 'isbn'], inplace=True)
    ...
    # idx 따로 저장 - idx에 len 대신 feature2idx 자체를 저장해야함
    # with open('idx.yml', 'w') as file:
    #     yaml.dump(idx, file, default_flow_style=False)
