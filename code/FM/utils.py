...
def models_load(args, data):
    ...
    elif args.model=='my_FM':
        model = MyFactorizationMachine(args, data).to(args.device)
    elif args.model=='my_FFM':
        model = MyFieldAwareFactorizationMachine(args, data).to(args.device)
    elif args.model=='FFM':
